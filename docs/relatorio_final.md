...
O trabalho terá sua estrutura visual aplicada em web, em paralelo ao desenvolvimento da modelagem de processos de negócios, especificamente de pequenos reparos, com foco na interatividade entre os usuários, os trabalhadores e as empresas, sendo a plataforma uma atuante mediadora desses processos. 
