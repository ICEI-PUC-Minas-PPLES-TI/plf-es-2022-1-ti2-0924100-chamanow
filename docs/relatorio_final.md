...
| Novos usuários | Avaliar o crescimento da plataforma | Mede o número de novos cadastros mensalmente | ∑(usuario(data_criacao))/∑(usuario(cod_usuario)) | usuario | Processos internos |
